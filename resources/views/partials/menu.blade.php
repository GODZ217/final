<ul class="sidebar-menu">
    ...
    <li class="nav-item ">
      <a href="/dashboard" class="nav-link "><img src="image/Vector.png" alt=""><span>Dashboard</span></a>
    </li>
    ...
    <li class="nav-item"><a class="nav-link" href="{{route('elearning')}}"><img src="image/Line.png" alt=""> <span>Form Elearning</span></a></li>
